"""
Authentication models for Doctype Engine
Includes custom User model with email as primary key, OAuth, MFA, and session management
"""
...
# ============================================================================
# USER MODEL (Email as Primary Key)
# ============================================================================
...
class MFADevice(models.Model):
    ...
    def save(self, *args, **kwargs):
        ...
        # Generate backup codes if needed (inline to avoid recursion)
...
# ============================================================================
# MAGIC LINK & SESSION MANAGEMENT (Legacy Authentication)
# ============================================================================
